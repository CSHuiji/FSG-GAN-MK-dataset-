...
#D:\SFTP\MK\lmk0824\data\prepared_image\img_align_celeba_crop
    ...
    dir_path = {
        "rand": dir_path_basic + "lfw_rand_tsst\\",
        "rand_gt": dir_path_basic + "lfw_rand_tsst_gt\\",
    }
    for i in dir_path:
    ...
    for iii in range(total_number):
        ...
        cur_img_path = os.path.join(img_dir_path, file_list[0][iii][0:-4]+".png")
        img = cv2.imread(cur_img_path, -1)
        f_name = file_list[0][iii][0:-4]+'.png'
